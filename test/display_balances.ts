...
async function main() {
  ...
  console.log("Balance TokenA in pool : ", balance_token_old_0.toNumber());
  console.log("Balance TokenB in pool : ", balance_token_old_1.toNumber());
  ...
  console.log('tokensOwedA : ', tokensOwed0);
  console.log('tokensOwedB : ', tokensOwed1);
